    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bookstack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i1 = new Intent(BookInfo.this, BookStack.class);
        ...
        materialstack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i2 = new Intent(BookInfo.this, MaterialStack.class);
        ...
        usercenter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i3 = new Intent(BookInfo.this, UserCenter.class);
